...
<html>
    ...
    <body>
        ...
        ?>
            ...
            <footer class="footer">
                <center><button><?php echo "<a href=evento_adm.php?excluir_gerente=".$id."><font color='#fff'>Confirmar</font></a>"; ?></button>
                    <button><?php echo "<a href=gerentes_cadastrados.php" . "><font color='#fff'>Cancelar</font></a>"; ?></button></center>
            </footer>
        </div>
    </body>
</html>
