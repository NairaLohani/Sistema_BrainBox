...
<html>
    ...
    <body>
        ...
        ?>
            ...
            <footer class="footer">
                <center><button><?php echo "<a href=evento_adm.php?excluir_cliente=".$id."><font color='#fff'>Confirmar</font></a>"; ?></button>
                    <button><?php echo "<a href=ver_cadastrados.php" . "><font color='#fff'>Cancelar</font></a>"; ?></button></center>
            </footer>
        </div>
    </body>
</html>
