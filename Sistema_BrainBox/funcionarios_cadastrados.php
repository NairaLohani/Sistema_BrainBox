...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Administrador-  Funcionarios Cadastrados</title>
    </head>
    <body>
        <?php
        ...
        <div class="tablebox">
            <table border="1">
                ...
                <?php while ($retorna = mysqli_fetch_array($consulta)) { ?>
                    <tr>
                        ...
                        <td><?php echo "<a href=delete_fun.php?deletar_funcionario=".$retorna['id_usuario']. ">Excluir</a>"; ?></td>
                    </tr>
                    <?php
                }
        } else {
            ?>
                ?>
        <div class="msg">Nenhum funcionário cadastrado no momento.</div>
        <?php
        }
        ?>
            </table>
